...
(use-package multiple-cursors
  ...
  :bind (("M-n" . mc/mark-next-like-this)
         ...
         ("C-c m s" . ar/set-mc/insert-numbers-starting-value)
...
(use-package org
  ...
  (org-after-todo-statistics . my/org-summary-todo) ;; omitted the -hook in org-after-todo-statistics-hook per use-package manual
...
(when (file-exists-p "~/.emacs.d/plugins/smcat-mode.el")
  ...
  (use-package smcat-mode
    ...
    (define-key smcat-mode-map (kbd "<prior>") '("\C-u1\M-v"))
    (define-key smcat-mode-map (kbd "<next>") '("\C-u1\C-v"))
